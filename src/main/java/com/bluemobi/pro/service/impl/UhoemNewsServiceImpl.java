...
@Service
public class UhoemNewsServiceImpl extends BaseService {
    public static String PREFIX = UhoemNewsServiceImpl.class.getName();
    ...
    public void read(Map<String,Object> params) throws Exception {
    	...
    	for (String id : ids) {
    		...
    		idMap.put("id", id);
    		idMap.put("memberId", params.get("memberId"));
			this.getBaseDao().save(PREFIX + ".modifyIsRead", idMap);
		}
    }
}